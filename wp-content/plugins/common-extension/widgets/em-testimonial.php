 ...
 * @since Layers 1.0.0
 */
if( class_exists('Layers_Widget') && !class_exists( 'em_testimonial' ) ) {
	class em_testimonial extends Layers_Widget {
		...
		*/
		function __construct() {
			...
			*/
			$this->widget_title = __( 'EM Testimonial Widget' , 'common' );
			$this->widget_id = 'em_testimonial';
			$this->post_type = 'em_testimonial';
			$this->taxonomy = 'em_testimonial_cat';
			...
			$widget_ops = array(
				...
				'description' => __( 'This widget is used for testimonial', 'common' ),
			...
			$this->defaults = array (
				'title' => __( 'Our <span>Testimonial</span>', 'common' ),
				'excerpt' => __( 'Lorem up to date with all our latest news and launches. Only the best quality makes it onto our testimonial!', 'common' ),
				'category' => 0,
				'text_style' => 'style1',
		...
		*/
		function widget( $args, $instance ) {
			...
			*/
			...
			$widget_container_class[] = 'em-testimonial-widget';
			...
			<div class="<?php echo $this->get_widget_layout_class( $instance ); ?>" >						
				...
				<div class="em40_row">
					...
					<?php while ($post_query->have_posts()) : $post_query->the_post(); 
						...
						$post_column_class = implode( ' ' , $post_column_class );					
							$em_rating  = get_post_meta( get_the_ID(),'_common_em_rating', true );				
							$testi_deg  = get_post_meta( get_the_ID(),'_common_testi_deg', true );
			
							?>
							
						
						<div class="<?php echo $post_column_class; ?>  col-xs-12"  data-cols="<?php echo $col_count; ?>" >

								<div class="single-testi single-testi2">
				...
				<?php }elseif( 'style2' == $this->check_and_return( $instance, 'text_style' )){?>
						...
						<div class="em40_row">
							<div class="owl-carousel em-testimonial-wrapper curosel-style">
								...
								<?php while ($post_query->have_posts()) : $post_query->the_post(); 
									...
									$post_column_class = implode( ' ' , $post_column_class );					
										...
										?>
											...
											<div class="<?php echo $post_column_class; ?> col-md-12 testi12">
												
												<div class="single-testi single-testi2 testi-style-2">
													<div class="testi-thumb">
														<?php the_post_thumbnail(); ?>
													</div>
													<div class="testi-content">
						...
						'elements' => array(
							'text-style-start' => array(
								...
								'text_style' => array(
									...
									'label' => __( '' , 'common' ),
									'options' => array(
											'style1' => __( 'Style !' , 'common' ),
											'style2' => __( 'Style 2 With Slide' , 'common' )
									)
								),							
	...
	// Add our function to the widgets_init hook.
	 register_widget("em_testimonial");
}