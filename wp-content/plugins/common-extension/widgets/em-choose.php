 ...
 * @since Layers 1.0.0
 */
if( class_exists('Layers_Widget') && !class_exists( 'em_choose' ) ) {
	class em_choose extends Layers_Widget {
		...
		*/
		function __construct() {
			...
			*/
			$this->widget_title = __( 'EM Choose Us Widget' , 'common' );
			$this->widget_id = 'em_choose';
			$this->post_type = '';
			$this->taxonomy = '';
			...
			$widget_ops = array(
				...
				'description' => __( 'This widget is used to display your choose widget.', 'common' ),
			...
			$this->defaults = array (
				'title' => __( 'why <span>choose</span> us', 'common' ),
		...
		*/
		function widget( $args, $instance ) {
			...
			*/
			...
			$widget_container_class[] = 'em-choose-widget';
			...
			<div id="<?php echo esc_attr( $widget_id ); ?>" class="<?php echo esc_attr( $widget_container_class ); ?>" <?php $this->selective_refresh_atts( $args ); ?>>
				...
				<?php do_action( 'layers_before_post_widget_inner', $this, $instance ); ?>
					...
					<div class="<?php echo $this->get_widget_layout_class( $instance ); ?>" >						
						...
						<div class="em40_row">
							<?php if( '' != $this->check_and_return( $instance, 'cimage' )  ) { ?>
								<div class="col-md-6">
							<?php }else{?>
								<div class="col-md-12">
							<?php }?>
							...
							<div class="em40_row">
								...
								<div class="col-md-12">
									...
									<?php if( '' != $this->check_and_return( $instance , 'title' ) ||'' != $this->check_and_return( $instance , 'excerpt' ) ) { ?>
											...
											*/
											...
											<div class="choose-excerpt <?php echo $section_title_class; ?>">
								...
								<?php if( '' != $this->check_and_return( $instance, 'tx1' )  ) { ?>
								...
								<?php } ?>
								<?php if( '' != $this->check_and_return( $instance, 'tx2' )  ) { ?>
								<div class="col-md-6 col-sm-6 col-sm-12">
									<div class="single_choose">
								...
								<?php } ?>
								<?php if( '' != $this->check_and_return( $instance, 'tx3' )  ) { ?>								
								<div class="col-md-6 col-sm-6 col-sm-12">
									<div class="single_choose">
								...
								<?php } ?>
								<?php if( '' != $this->check_and_return( $instance, 'tx4' )  ) { ?>								
								<div class="col-md-6 col-sm-6 col-sm-12">
									<div class="single_choose">
						...
						<div class="col-md-6 col-sm-12 col-sm-12">
							...
							<div class="single-video">
								<img src="<?php echo wp_get_attachment_url( $instance['cimage'] );?>" alt="" />
								<div class="choose-video-icon">								
								<div class="video-icon">
									<?php if( '' != $this->check_and_return( $instance, 'pyoutube' )  ) { ?>
									<a class="video-vemo-icon venobox" data-vbtype="youtube" data-autoplay="true" href="<?php echo esc_url($instance['pyoutube'] ); ?>"><i class="fa fa-youtube-play"></i></a>	
								
									<?php }elseif( '' != $this->check_and_return( $instance, 'pvimeo' )  ) { ?>		
																
										<a class="video-vemo-icon venobox" data-vbtype="vimeo" data-autoplay="true" href="<?php echo esc_url($instance['pvimeo']); ?>"><i class="fa fa-vimeo"></i>
										</a>
								<?php }else{
			...
			<div class="layers-container-large">
				...
				<section class="layers-accordion-section layers-content">
					...
					<div class="layers-row layers-push-bottom">
						...
						<div class="layers-form-item">
								<h2><?php esc_html_e('Image and Video','common');?></h2>
						</div>
						<div class="layers-form-item">	
							<p>
							<?php echo $this->form_elements()->input(
								array(
									'type' => 'image',
									'name' => $this->get_layers_field_name( 'cimage' ) ,
									'id' => $this->get_layers_field_id( 'cimage' ) ,
									'placeholder' => __( 'Set Image' , 'common' ),
									'value' => ( isset( $instance['cimage'] ) ) ? $instance['cimage'] : NULL,
									'class' => 'layers-large layers-text'
								)
							); ?>
							</p>
							<p>
							<?php echo $this->form_elements()->input(
								array(
									'type' => 'text',
									'name' => $this->get_layers_field_name( 'pyoutube' ) ,
									'id' => $this->get_layers_field_id( 'pyoutube' ) ,
									'placeholder' => __( 'Set Youtube Link' , 'common' ),
									'value' => ( isset( $instance['pyoutube'] ) ) ? $instance['pyoutube'] : NULL,
									'class' => 'layers-text'
								)
							); ?>
							</p>
							...
							<?php echo $this->form_elements()->input(
								array(
									'type' => 'text',
									'name' => $this->get_layers_field_name( 'pvimeo' ) ,
									'id' => $this->get_layers_field_id( 'pvimeo' ) ,
									'placeholder' => __( 'Set Vimeo Link' , 'common' ),
									'value' => ( isset( $instance['pvimeo'] ) ) ? $instance['pvimeo'] : NULL,
									'class' => 'layers-text'
								)
							); ?>
							</p>							
