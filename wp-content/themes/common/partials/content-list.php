				...
				<div class="common-single-blog">													
					...
					<?php if(has_post_thumbnail()){?>
						<div class="common-blog-thumb home-b">
							<a href="<?php the_permalink(); ?>"> <?php the_post_thumbnail('common-blog-single'); ?> </a>
					...
					<?php }else{
						echo layers_post_featured_media( array( 'postid' => get_the_ID(), 'wrap_class' => '', 'size' => 'common-blog-single' ) );
					} ?>
